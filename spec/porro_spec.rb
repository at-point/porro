...
RSpec.describe Porro do
  ...
  context '::Model' do
    ...
    it 'has attributes' do
      expect(SomeObject.nomodel_attributes).to eq [:name, :loves_chocolate, :strength]
    end
  ...
  context '::UberObject' do
    ...
    it 'has more attributes' do
      expect(UberObject.nomodel_attributes).to eq [:name, :loves_chocolate, :strength, :magic]
    end
